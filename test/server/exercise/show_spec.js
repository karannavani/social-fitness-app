...
const exercisePlanData = [
  {
    ...
    user: '5b91752666708bc8b1622706', //require a user plan
    startDate: today, //require a unix start date
    name: 'TestPlan2',
...
describe('GET /exerciseplans/:id', () => {  //testing the exercise show route
  ...
  it('should return a 200 response', done => {
    api.get(`/api/exerciseplans/${exercisePlanId}`)
      .end((err, res) => {
  ...
  it('should return the correct data', done => {
    api.get(`/api/exerciseplans/${exercisePlanId}`)
      .end((err, res) => {
        ...
        expect(res.body.startDate).to.eq(today);
